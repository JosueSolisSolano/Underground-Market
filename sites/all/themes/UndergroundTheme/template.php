 ...
 *
 */
function underground_preprocess_page(&$variables) {
 ...
 */
function underground_preprocess_html(&$variables) {
  $meta_charset = array(
    '#tag' => 'meta',
    '#attributes' => array(
      'charset' => 'utf-8',
  ...
  drupal_add_html_head($html5shiv, 'underground_theme_html5shiv');
  // ENDTODO
  ...
  drupal_add_html_head($respondjs, 'underground_theme_respondjs');
  // ENDTODO
 ...
 */
function underground_html_head_alter(&$head_elements) {
 ...
 */
function underground_page_alter(&$page) {
...
function underground_preprocess_node(&$vars) {
  // Add a striping class.
  $vars['classes_array'][] = 'node-' . $vars['zebra'];
}

function underground_preprocess_block(&$vars, $hook) {
  // Add a striping class.
